...
class MusicPlayer(
    ...
    private val mediaBrowserConnectionCallback: MediaBrowserConnectionCallback = MediaBrowserConnectionCallback(context)
    ...
    private inner class MediaBrowserConnectionCallback(
        ...
        override fun onConnectionFailed() {
            _isConnected.postValue(Event(Resource.error("Couldn't connect to the media browser", false)))
        }
